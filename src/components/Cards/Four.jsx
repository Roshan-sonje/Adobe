      ...
      <>
        ...
        <div className="container flex flex-wrap gap-5 justify-center mx-auto lg:px-20 px-5">
          <Card
            ...
            title="Premiere Pro"
            desc="Best for making videos shine, from social clips to feature films."
            btn1="Learn more"
            btn2="Free trial"
            color="bg-[#033E6E]"
            btn1_Color="white"
          ...
          <Card
            ...
            title="After Effects"
            desc="Best for making animated graphics and visual effects."
            btn1="Learn more"
            btn2="Free trial"
            color="bg-[#9999FF]"
            sec_bg="/src/assets/after.jpg"
            btn1_Color="black"
            btn2_Color="black"
            btn2_Tcolor="white"
            text_Color="black"
          ...
          <Card
            logo="https://www.adobe.com/cc-shared/assets/img/product-icons/svg/audition.svg"
            title="Audition"
            desc="Best for quick photo edits like cropping and removing backgrounds."
            btn1="Learn more"
            btn2="Free trial"
            color="bg-[#BEBEFF]"
            sec_bg="/src/assets/audition.jpg"
            btn1_Color="black"
            btn2_Color="black"
            btn2_Tcolor="white"
            text_Color="black"
